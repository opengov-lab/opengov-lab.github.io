...
Her thesis, **“[Beyond Disclosure: Evaluating Algorithmic Transparency in the Dutch Algorithm Register](https://scripties.uba.uva.nl/search?id=c13578141),”** examines the Dutch Algorithm Register as a case study to evaluate the extent to which algorithm disclosures support democratic oversight, and to analyze institutional dynamics that shape these transparency practices. 

The jury called the work *“an important study that deserves a wider audience - the kind of independent and critical research we need in times when both democracy and the social value of the humanities are under pressure.”*
